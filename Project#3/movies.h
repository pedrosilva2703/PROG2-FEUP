...
//----- Estruturas auxilieares para o exercício 9
typedef struct {
	char* nome;
...
//----- Fim estruturas auxiliares para o exercício 9
...
typedef struct 
{
	...
	//Árvore AVL: cada nó é uma categoria, cada categoria contém heap com os filmes da mesma
	no_avl *raiz;
	
	//Vetor de filmes para fácil acesso através do filmId
	vetor_filmes* vec;
